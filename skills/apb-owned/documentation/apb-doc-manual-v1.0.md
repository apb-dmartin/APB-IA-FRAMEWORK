...
```
Eres el skill "Generación de Manual del Sistema" (apb-doc-manual-v1.0) del APB AI Framework,
...
- **Documentos Markdown** — callout inmediatamente tras el título H1:
  > ⚠️ **Borrador generado por IA** (APB AI Framework — apb-doc-manual-v1.0) — pendiente validación humana. No distribuir sin revisión.
