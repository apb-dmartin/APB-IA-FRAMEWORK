...
|---|---|---|---|---|
| `third-anthropic-business-discovery-v1.0` | https://github.com/anthropics/skills | MIT | approved | `skills/third_party/anthropic/third-anthropic-business-discovery-v1.0.md` |
| `third-anthropic-document-skills-v1.0` | https://github.com/anthropics/skills | Source-available (no open source) — ver THIRD_PARTY_NOTICES.md del repositorio de origen | approved | `skills/third_party/anthropic/third-anthropic-document-skills-v1.0.md` |
...
| `third-expo-docker-cicd-v1.0` | https://github.com/expo/skills | MIT | approved | `skills/third_party/expo/third-expo-docker-cicd-v1.0.md` |
| `third-garrytan-cso-owasp-v1.0` | https://github.com/garrytan/gstack | MIT | approved | `skills/third_party/garrytan/third-garrytan-cso-owasp-v1.0.md` |
| `third-garrytan-post-deploy-validation-v1.0` | https://github.com/garrytan/gstack | MIT | approved | `skills/third_party/garrytan/third-garrytan-post-deploy-validation-v1.0.md` |
...
| `third-mukul-dfir-forensic-v1.0` | https://github.com/mukul975/Anthropic-Cybersecurity-Skills | MIT | approved | `skills/third_party/mukul975/third-mukul-dfir-forensic-v1.0.md` |
| `third-mukul-risk-policies-v1.0` | https://github.com/mukul975/Anthropic-Cybersecurity-Skills | MIT | approved | `skills/third_party/mukul975/third-mukul-risk-policies-v1.0.md` |
...
| `third-sickn33-domain-driven-design-v1.0` | https://github.com/sickn33/antigravity-awesome-skills | MIT | draft | `skills/third_party/sickn33/third-sickn33-domain-driven-design-v1.0.md` |
| `third-sickn33-event-store-design-v1.0` | https://github.com/sickn33/antigravity-awesome-skills | MIT | draft | `skills/third_party/sickn33/third-sickn33-event-store-design-v1.0.md` |
