# Procedimiento de Evaluación de Riesgos en Incumplimientos - Política QA Docks
...
- Que la criticidad debe valorarse considerando impacto en seguridad, disponibilidad/estabilidad, integridad de datos, sostenibilidad tecnológica y exposición normativa.
...
Ejemplo: Riesgo de acceso no autorizado debido a falta de autenticación en endpoints, afectando al sistema de gestión de clientes.

### Dimensiones de impacto (ENS)

Cada riesgo se evalúa en cuatro dimensiones: Confidencialidad (C), Integridad (I), Disponibilidad (D) y Trazabilidad (T).

- **Escala de impacto:** Muy bajo / Bajo / Medio / Alto / Crítico.
...
Se valoran los controles existentes y su efectividad.
...
Escala: Bajo / Medio / Alto / Crítico.

### Tratamiento del riesgo (ISO 27001)

Todo riesgo debe tener un tratamiento definido: Mitigar / Aceptar / Transferir / Evitar.

### Criterios de aceptación del riesgo

- Riesgo Bajo o Medio: aceptable con seguimiento.
- Riesgo Alto: requiere medidas compensatorias y aprobación formal.
- Riesgo Crítico: no aceptable; requiere remediación inmediata o decisión de dirección.

## 4. Análisis de riesgos por incumplimiento

### 4.1. Riesgo de seguridad y control de acceso
...
### 4.2. Riesgo de ocultación de errores y degradación de la operabilidad
...
### 4.3. Riesgo por uso de SOAP/WebService no homologado
...
### 4.4. Riesgo por uso de plantillas base desactualizadas
...
### 4.5. Riesgo por documentación insuficiente
...
### 4.6. Riesgo por incumplir el Quality Gate de Sonar

La política establece umbrales mínimos de QA; su incumplimiento puede afectar a estabilidad, deuda técnica o vulnerabilidades.

**Blocker Issues > 0**

Las incidencias Blocker pueden comprometer el funcionamiento, generar fallos en ejecución o introducir vulnerabilidades explotables, y no son compatibles con un despliegue seguro.
...
Valoración: Alta o crítica por definición del propio criterio en Sonar.

**Cobertura < 60 %**

La cobertura mínima reduce la probabilidad de que errores no detectados lleguen a producción y facilita la estabilidad del software ante cambios futuros.
...
Argumento: La baja cobertura no prueba por sí sola que el software falle, pero sí aumenta razonablemente la incertidumbre operativa y el riesgo de defectos no descubiertos antes de PRE/PRO.

Valoración: Media-Alta; sube a Alta si el cambio es grande o el servicio es crítico.
...
Valoración: Media a corto plazo; Alta como riesgo acumulativo y arquitectónico.
...
Valoración: Media por defecto; Alta si el servicio es relevante o crítico.
...
Valoración: Alta por defecto; Crítica si hay datos sensibles o exposición externa.

### 4.7. Riesgo por eludir la clasificación Compliance/Legacy y controles del pipeline
...
### 4.8. Riesgo de despliegue con incumplimientos en PRE/PRO
...
## 5. Catálogo de riesgos corporativo

El catálogo de riesgos corporativo cubre las siguientes áreas:

- Desarrollo seguro
- QA
- Integración

Los riesgos específicos de cada área, con sus identificadores, descripciones, dimensiones de impacto, valoraciones y tratamientos, se mantienen en el registro corporativo de riesgos gestionado en Jira.

## 6. Riesgos transversales

### 6.1. Riesgo de pérdida de trazabilidad y auditabilidad
...
Cuando se incumplen controles y además se relajan registro/seguimiento, el problema deja de ser sólo técnico: pasa a ser también de gobernanza, siendo más difícil analizar causa raíz o sostener una aceptación de riesgo ante auditoría.

### 6.2. Riesgo de acumulación de deuda técnica y excepciones
...
### 6.3. Riesgo de debilitamiento del control preventivo
...
### 6.4. Riesgo normativo y de gestión del riesgo insuficiente

La aceptación de riesgos y las excepciones se han definido de forma alineada con ENS e ISO 27001. Por tanto, una excepción mal argumentada, sin medidas compensatorias ni fecha de corrección, no sólo aumenta riesgo técnico: también debilita el marco formal de gestión del riesgo.

## 7. Autorización de excepciones
...
- Se justifiquen por falta de tiempo, planificación deficiente o presión de entrega (el procedimiento general de gestión de incumplimientos lo define expresamente).
...
Evaluación detallada de cada riesgo identificado.
