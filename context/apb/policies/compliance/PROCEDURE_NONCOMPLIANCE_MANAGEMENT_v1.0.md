# Procedimiento - Gestión de Incumplimientos - v1.0
...
- Asegurar el cumplimiento de marcos normativos aplicables, como el Esquema Nacional de Seguridad (ENS) o ISO 27001.
...
La aceptación de riesgos deberá quedar registrada y ser trazable, de acuerdo con los principios de gestión del riesgo definidos en el Esquema Nacional de Seguridad (ENS) y en ISO/IEC 27001.
...
### 3.1. Responsables de políticas según su naturaleza
...
2. Registro formal del incumplimiento
3. Análisis del incumplimiento
4. Definición y ejecución de acciones correctivas
5. Validación independiente de la corrección
6. Cierre del incumplimiento
...
## 5. Detección de incumplimientos
...
### 5.3. Notificación de incumplimientos
...
## 6. Clasificación de incumplimientos
...
## 7. Registro y evidencias de incumplimientos
...
### 7.1. Registro del incumplimiento
...
### 7.2. Generación automática de registros
...
### 7.3. Evidencias del incumplimiento
...
### 7.4. Estados del proceso de gestión
...
### 7.5. Principio de control y auditoría
...
## 8. Escalado, seguimiento, corrección y cierre
...
### 8.1. Análisis del incumplimiento
...
### 8.2. Definición y ejecución de acciones correctivas
...
### 8.3. Seguimiento del incumplimiento
...
### 8.4. Escalado de incumplimientos
...
### 8.5. Validación de la corrección
...
### 8.8. Monitorización y cuadro de mando de incumplimientos
...
Las excepciones deberán gestionarse conforme a los principios de gestión del riesgo establecidos en el Esquema Nacional de Seguridad (ENS) y en ISO/IEC 27001.
...
### 9.1. Registro de la solicitud de excepción
...
### 9.2. Condiciones de las excepciones
...
### 9.4. Seguimiento de excepciones
...
### 9.5. Criterios de valoración de excepciones
...
La relación de situaciones descrita a continuación no tiene carácter exhaustivo. Cualquier solicitud de excepción basada en causas evitables o derivadas de una planificación inadecuada podrá ser rechazada por el responsable correspondiente. No se aceptarán como justificación para la concesión de una excepción, entre otras, las siguientes situaciones:
...
### 9.6. Excepción de Emergencia (Fast-track)
...
### 9.7. Criterio Legacy y Compliance
...
### 9.8. Principio de no empeoramiento (Legacy)
...
### 9.9. Principio de no acumulación de excepciones
...
Por este motivo, durante el proceso de evaluación de una nueva solicitud de excepción, los responsables técnicos podrán considerar:
...
## 10. Tiempos de resolución y gestión de excepciones
...
## 11. Especificaciones según políticas concretas
...
### 11.1. QA en desarrollo a medida Docks
